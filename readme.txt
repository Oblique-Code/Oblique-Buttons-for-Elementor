...
* Full style controls for Normal, Hover, Focus, and Active states: typography, background (including gradients), text color, border, border radius, box shadow, padding, min width, width, and alignment
